...
public class SecurityConfig {
    ...
    //    Este métod. é utilizado para autenticar em memória (vimos isso em Basic Authentication, antes de criar as tabelas da feat usuarios, para autheticação por bando de dados)
//
